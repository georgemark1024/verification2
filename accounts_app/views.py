...
from accounts_app import serializers, models
...
class SignUp(GenericAPIView):
    ...
    def post(self, request):
        ...
        tokens = RefreshToken.for_user(user_email).access_token # access_token not defined
...
class VerifyEmail(GenericAPIView):
    serializer_class = serializers.EmailVerficationSerializer
